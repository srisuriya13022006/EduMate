...
def main():
    ...
    parser.add_argument('--gemini-model', type=str, default="gemini-2.5-flash", help="Gemini model to use")
...
class StudyMatePipeline:
    ...
    def generate_answer(self, query_text: str, results: List[Dict], model: str = "http://localhost:6000/generate", gemini_model: str = "gemini-2.5-flash") -> str:
